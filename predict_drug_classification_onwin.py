...
model = RobertaForMaskedLM.from_pretrained('C:\\Users\\nisar\\cs\ml3\\SmileBERTa\\model_drug_classification')#enter path of the model from train_model.py
tokenizer = RobertaTokenizer.from_pretrained('C:\\Users\\nisar\\cs\ml3\\SmileBERTa\\tokenizer_drug_classification')#enter path of the tokenizer from train_model.py
model.eval()
